...
export const VOCABULARY = [
  ...
  { id: 'apple-pie', name: 'Apple pie', cat: 'cake', f101: 'apple_pie', syn: ['slice of apple pie'], fndds: 'Apple pie', serve: 155 },
  ...
  { id: 'chocolate-cake', name: 'Chocolate cake', cat: 'cake', f101: 'chocolate_cake', fndds: ['Chocolate cake'], serve: 110 },
  ...
  { id: 'dumplings', name: 'Dumplings', cat: 'pile', f101: 'dumplings', syn: ['steamed dumplings', 'chinese dumplings'], fndds: ['Dumpling, meat', 'Dumpling'], rho: 0.9, serve: 150 },
  ...
  { id: 'onion-rings', name: 'Onion rings', cat: 'snack', f101: 'onion_rings', fndds: ['Onion rings, from fast food', 'Onion rings'], h: 5, rho: 0.35, serve: 110 },
  ...
  { id: 'poutine', name: 'Poutine', cat: 'snack', f101: 'poutine', syn: ['fries with gravy and cheese curds'], fndds: ['White potato, french fries, with cheese', 'french fries'], h: 5, rho: 0.6, serve: 300 },
  ...
  { id: 'spaghetti-bolognese', name: 'Spaghetti bolognese', cat: 'pile', f101: 'spaghetti_bolognese', syn: ['spaghetti with meat sauce'], fndds: ['Spaghetti with meat sauce', 'Pasta with meat sauce'], serve: 320 },
  ...
  { id: 'chapati', name: 'Chapati / Roti', cat: 'flat', syn: ['roti', 'indian flatbread chapati'], fndds: ['Roti', 'Chapati'], h: 0.4, rho: 0.9, serve: 45 },
  ...
  { id: 'paneer-tikka', name: 'Paneer tikka', cat: 'meat', syn: ['grilled indian paneer cubes'], fndds: ['Paneer'], serve: 150 },
  ...
  { id: 'rajma', name: 'Rajma', cat: 'pile', syn: ['indian kidney bean curry'], fndds: ['Kidney bean', 'Beans, red kidney'], rho: 0.9, serve: 220 },
  ...
  { id: 'tandoori-chicken', name: 'Tandoori chicken', cat: 'meat', syn: ['indian tandoori roasted chicken'], fndds: ['Tandoori chicken', 'Chicken, roasted'], serve: 200 },
  ...
  { id: 'lassi', name: 'Lassi', cat: 'drink', syn: ['indian yogurt lassi drink', 'mango lassi'], fndds: ['Lassi', 'Yogurt drink'], serve: 250 },

  // ============================= East & Southeast Asian =============================
  { id: 'chow-mein', name: 'Chow mein', cat: 'pile', syn: ['chinese stir-fried noodles'], fndds: ['Chow mein, NS', 'Chow mein'], serve: 300 },
  ...
  { id: 'roast-chicken', name: 'Roast chicken', cat: 'meat', syn: ['roasted chicken', 'rotisserie chicken'], fndds: ['Chicken, whole, roasted', 'Chicken, roasted'], serve: 200 },
  ...
  { id: 'oatmeal', name: 'Oatmeal', cat: 'soup', syn: ['bowl of oatmeal porridge'], fndds: ['Oatmeal, NS as to fat', 'Oatmeal, cooked'], serve: 240 },
  ...
  { id: 'chocolate-bar', name: 'Chocolate', cat: 'dessert', syn: ['chocolate bar pieces'], fndds: ['Chocolate, NFS', 'Milk chocolate'], h: 1, rho: 1.2, serve: 40 },
